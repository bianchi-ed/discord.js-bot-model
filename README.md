...
Here is an example of the execution of a pre-existing command created using the SlashCommandBuilder class. In this case, the command fetches the target user avatar and replies to the channel where it was called.
